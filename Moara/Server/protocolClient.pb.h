...
/* @@protoc_insertion_point(class_definition:WhereToMovePiece) */ {
 ...
 public:
  ...
  public:
  void clear_pair() ;
  ::IntPair* mutable_pair(int index);
  ::google::protobuf::RepeatedPtrField<::IntPair>* mutable_pair();

  private:
  const ::google::protobuf::RepeatedPtrField<::IntPair>& _internal_pair() const;
  ::google::protobuf::RepeatedPtrField<::IntPair>* _internal_mutable_pair();
  public:
  const ::IntPair& pair(int index) const;
  ::IntPair* add_pair();
  const ::google::protobuf::RepeatedPtrField<::IntPair>& pair() const;
  // int32 x = 1;
  void clear_x() ;
  ::int32_t x() const;
  void set_x(::int32_t value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::IntPair > pair_;
    ::int32_t x_;
    ::int32_t y_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
...
/* @@protoc_insertion_point(class_definition:UndoAction) */ {
 ...
 public:
  ...
  int positon_size() const;
  private:
  int _internal_positon_size() const;

  public:
  void clear_positon() ;
  ::IntPair* mutable_positon(int index);
  ::google::protobuf::RepeatedPtrField<::IntPair>* mutable_positon();

  private:
  const ::google::protobuf::RepeatedPtrField<::IntPair>& _internal_positon() const;
  ::google::protobuf::RepeatedPtrField<::IntPair>* _internal_mutable_positon();
  public:
  const ::IntPair& positon(int index) const;
  ::IntPair* add_positon();
  const ::google::protobuf::RepeatedPtrField<::IntPair>& positon() const;
  // int32 state = 1;
  void clear_state() ;
  ::int32_t state() const;
  void set_state(::int32_t value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::IntPair > positon_;
    ::int32_t state_;
    ::int32_t player_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
...
// repeated .IntPair pair = 3;
inline int WhereToMovePiece::_internal_pair_size() const {
  return _internal_pair().size();
}
inline int WhereToMovePiece::pair_size() const {
  return _internal_pair_size();
}
inline void WhereToMovePiece::clear_pair() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.pair_.Clear();
}
inline ::IntPair* WhereToMovePiece::mutable_pair(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:WhereToMovePiece.pair)
  return _internal_mutable_pair()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::IntPair>* WhereToMovePiece::mutable_pair()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:WhereToMovePiece.pair)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_pair();
}
inline const ::IntPair& WhereToMovePiece::pair(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:WhereToMovePiece.pair)
  return _internal_pair().Get(index);
}
inline ::IntPair* WhereToMovePiece::add_pair() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::IntPair* _add = _internal_mutable_pair()->Add();
  // @@protoc_insertion_point(field_add:WhereToMovePiece.pair)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::IntPair>& WhereToMovePiece::pair() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:WhereToMovePiece.pair)
  return _internal_pair();
}
inline const ::google::protobuf::RepeatedPtrField<::IntPair>&
WhereToMovePiece::_internal_pair() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.pair_;
}
inline ::google::protobuf::RepeatedPtrField<::IntPair>*
WhereToMovePiece::_internal_mutable_pair() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.pair_;
}
...
// int32 difficulty = 1;
inline void SetStrategy::clear_difficulty() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.difficulty_ = 0;
}
inline ::int32_t SetStrategy::difficulty() const {
  // @@protoc_insertion_point(field_get:SetStrategy.difficulty)
  return _internal_difficulty();
}
inline void SetStrategy::set_difficulty(::int32_t value) {
  _internal_set_difficulty(value);
  // @@protoc_insertion_point(field_set:SetStrategy.difficulty)
}
inline ::int32_t SetStrategy::_internal_difficulty() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.difficulty_;
}
inline void SetStrategy::_internal_set_difficulty(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
// repeated .IntPair positon = 3;
inline int UndoAction::_internal_positon_size() const {
  return _internal_positon().size();
}
inline int UndoAction::positon_size() const {
  return _internal_positon_size();
}
inline void UndoAction::clear_positon() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.positon_.Clear();
}
inline ::IntPair* UndoAction::mutable_positon(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:UndoAction.positon)
  return _internal_mutable_positon()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::IntPair>* UndoAction::mutable_positon()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:UndoAction.positon)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_positon();
}
inline const ::IntPair& UndoAction::positon(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:UndoAction.positon)
  return _internal_positon().Get(index);
}
inline ::IntPair* UndoAction::add_positon() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::IntPair* _add = _internal_mutable_positon()->Add();
  // @@protoc_insertion_point(field_add:UndoAction.positon)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::IntPair>& UndoAction::positon() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:UndoAction.positon)
  return _internal_positon();
}
inline const ::google::protobuf::RepeatedPtrField<::IntPair>&
UndoAction::_internal_positon() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.positon_;
}
inline ::google::protobuf::RepeatedPtrField<::IntPair>*
UndoAction::_internal_mutable_positon() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.positon_;
}
